...
6. Deberias de ver "Python 3.10.6" desplegado en la ventana, como en la siguente imagen.
...
Al confirmar la instalacion de Python, siguente debemos crear un carpeta nueva para nuestro programa. La puede crear donde usted guste pero por simplicidad la puede crear en su escritorio. Al crear la carpeta, podemos dejar oprimido "Shift" y hacer click derecho en la carpeta y buscar por la opcion "Abrir con Powershell".
